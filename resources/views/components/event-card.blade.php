...
<a href="{{ route('event.details', ['id' => $event->id]) }}" class="flex flex-col w-full bg-[#27292a] p-4 pb-6 gap-5 rounded-xl hover:scale-105 transition-transform duration-300">
