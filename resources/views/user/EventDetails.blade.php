        ...
        <div class="flex flex-col gap-8 px-4 w-full">
          <h1 class="text-3xl uppercase font-semibold tracking-wide">JKT48 13th Anniversary Concert & Sousenkyo Announcement</h1>
           <div class="flex flex-row gap-5">
               ...
               <button id="lokasi-btn" class="bg-[#ec6090] px-6 py-2 capitalize rounded-full hover:bg-[#ff84af] duration-200 cursor-pointer">lokasi</button>           </div>         <div class="flex flex-row gap-6 w-full">           <div class="flex flex-col gap-6 w-full" id="content-area">             <h2 class="text-2xl font-medium">Deskripsi</h2>             <span class="text-neutral-300">               Terima kasih atas dukungannya untuk JKT48. <br> &nbsp; <br>               Karena banyaknya cinta dan dukungan yang kalian berikan, JKT48 dapat terus bertahan dan berkembang hingga memasuki tahun yang ke-13 ini. Oleh karena itu, JKT48 ingin merayakannya bersama kalian semua dalam JKT48 13th Anniversary Concert yang bertajuk "WONDERLAND". Akan ada dua pertunjukan yang diadakan pada event kali ini, yaitu 13th Anniversary Concert dan juga Sousenkyo Announcement (Pengumuman Hasil Akhir Pemilihan Member Single ke-26 JKT48).<br> &nbsp; <br>               Penjualan Tiket presale khusus untuk anggota OFC akan dibuka pada tanggal 16 Oktober 2024 pukul 14.00 WIB, dan penjualan Tiket general akan dibuka pada tanggal 23 Oktober 2024 pukul 14.00 WIB.
               </span>
             </div>
             <div class="w-[35%]">
